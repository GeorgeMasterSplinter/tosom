...
export const componentRegistry: Record<Platform, Record<string, string>> = {
  web: {
    ...
    AIRewritePanel: '@/components/ai/AIRewritePanel',
    AIJourneyGuide: '@/components/ai/AIJourneyGuide',
    AIIcebreakers: '@/components/ai/AIIcebreakers',
  ...
  pwa: {
    ...
    AIInsightsPanel: '@/components/ui/mobile/AIInsightsPanel',
    AIRewritePanel: '@/components/ui/mobile/AIRewritePanel',
    AIJourneyGuide: '@/components/ui/mobile/AIJourneyGuide',
    AIIcebreakers: '@/components/ui/mobile/AIIcebreakers',
  ...
  mobile: {
    ...
    Stack: '', SplitView: '', AIInsightsPanel: '', AIRewritePanel: '',
    AIJourneyGuide: '', AIIcebreakers: '', TimelineV2: '',
  ...
  desktop: {
    ...
    AIInsightsPanel: '@/components/ui/desktop/AIInsightsPanel',
    AIRewritePanel: '@/components/ui/desktop/AIRewritePanel',
    AIJourneyGuide: '@/components/ui/desktop/AIJourneyGuide',
    AIIcebreakers: '@/components/ui/desktop/AIIcebreakers',
