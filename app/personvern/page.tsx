...
const sections = [
  {
    ...
    content: 'Vi samler bare det vi trenger for å gi deg den beste opplevelsen. Dette inkluderer e-post, profilspørsmål og samtalehistorikk. Ingen sporing til markedsføringsformål.',
  },
  {
    title: 'Hvorfor vi samler data',
    content: 'Dataene våre blir bare brukt til å gi deg de beste matchene. Vi bruker aldri data til å selge annonser eller dele med tredjepart.',
  },
  {
    title: 'Hvor dataene dine blir lagret',
    content: 'Alle dataene dine blir lagret i trygge, krypterte databaser på servere i EU/EØS. Vi følger GDPR fullt ut.',
  },
  {
    title: 'Dine rettigheter',
    content: 'Du har rett til å be om sletting, endring eller eksport av dine data. Kontakt oss på hvilken som helst måte for å utøve dine rettigheter.',
  },
  {
    title: 'Cookies og sporing',
    content: 'Vi bruker minimalt med cookies. Bare de som er teknisk nødvendige for at siden skal fungere.',
  },
  {
    title: 'Deling av data',
    content: 'Vi deler aldri dine personlige data med noen. Dine svar er krypterte og aldri synlige for andre brukere.',
  },
];
        ...
        <section className="pt-32 pb-20 text-center" style={{ background: 'linear-gradient(180deg, #162032 0%, #0F1923 50%, #0B1520 100%)' }}>
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="max-w-2xl mx-auto leading-relaxed" style={{ ...typographyToStyle('body-lg'), color: color.text.secondary }}>
              ToSom er laget for voksne mennesker som er <AgeRequirement />. Vi tar personvern svært alvorlig — alt du deler er kryptert og aldri synlig for andre.
            </p>
          </div>
        </section>
