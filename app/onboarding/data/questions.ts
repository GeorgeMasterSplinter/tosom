...
export const step0Data = {
  ...
  example: '178 cm, aktiv, liker turer men ikke fullt ut.',
  fields: {
    ...
    gender: { label: 'Ditt kjønn', type: 'select', options: [
      ...
      { value: 'ikke-ønske', label: 'Vil ikke oppgi' },
    ]},
    seekingGender: { label: 'Hva søker du?', type: 'select', options: [
      { value: 'man', label: 'Mann' },
      { value: 'kvinne', label: 'Kvinne' },
      { value: 'begge', label: 'Begge deler' },
      { value: 'annen', label: 'Annet' },
    ]},
    ...
    bodyType: { label: 'Kroppstype', type: 'select', options: [
      ...
      { value: 'muskuløs', label: 'Muskuløs' },
      { value: 'fullstendig', label: 'Fullstendig' },
      { value: 'annen', label: 'Annet' },
    ]},
...
export const step1Data = {
  ...
  subtitle: 'Dette handler ikke om å være perfekt, men om å bli forstått.',
  ...
  questions: [
    ...
    { name: 'energyDrainer', label: 'Hva tapper deg for energi?', placeholder: 'Det som tapper meg...', example: 'Støy, overfladiske samtaler...' },
...
export const step2Data = {
  ...
  subtitle: 'Dette hjelper oss å matche deg med noen som møter deg på en god måte.',
  example: 'Jeg trenger tydelige ord for å føle meg trygg, men også fysiske uttrykk.',
  questions: [
...
export const step3Data = {
  ...
  questions: [
    ...
    { name: 'conflictStyle', label: 'Hvordan håndterer du konflikter?', placeholder: 'Når det blir konflikt...', example: 'Jeg trenger tid før jeg snakker...' },
...
export const step4Data = {
  ...
  questions: [
    ...
    { name: 'smallThing', label: 'Hva er en liten ting som betyr mye?', placeholder: 'Den lille ting...', example: 'Når noen husker at jeg teer meg svart...' },
  ],
};
...
export const step5Data = {
  ...
  questions: [
    { name: 'highPriority', label: 'Hva prioriterer du høyt i livet?', placeholder: 'Det jeg setter først...', example: 'Familie, helse og personlig vekst...' },
...
export const step6Data = {
  ...
  subtitle: 'Hvordan ser du for deg selv og livet ditt om noen år?',
  example: 'Jeg vil bygge noe meningsfullt – med meg selv og med noen jeg er glad i.',
  questions: [
    { name: 'futureVision', label: 'Hvordan ser en god fremtid ut for deg?', placeholder: 'Min framtid...', example: 'En der jeg har vokst som menneske og har dype relasjoner...' },
...
export const step7Data = {
  ...
  example: 'Jeg har en tendens til å spøke med at jeg er professionell overtenner.',
  questions: [
    { name: 'laughterTrigger', label: 'Hva får deg til å le?', placeholder: 'Det som får meg til å le...', example: 'Dyrevideoer, absurd humor og overraskende situasjoner...' },
...
export const step8Data = {
  ...
  questions: [
    ...
    { name: 'intimacyBoundary', label: 'Hva er en grense du setter i intime situasjoner?', placeholder: 'Min grense...', example: 'Jeg trenger alltid å kunne si nei uten konsekvenser...' },
...
export const step9Data = {
  ...
  questions: [
    ...
    { name: 'sleepSchedule', label: 'Søvnrytme', placeholder: '', type: 'select', options: [
      { value: 'tidlig-bør', label: 'Tidlig opp, tidlig opp' },
      { value: 'normal', label: 'Normal' },
