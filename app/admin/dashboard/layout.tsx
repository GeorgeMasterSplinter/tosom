...
/**
 * ToSom — Admin Dashboard Layout (innlogga sider)
 * 
...
function NavItem({ href, icon, label }: {
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-3 px-3 py-2 rounded-xl text-sm transition-all duration-200 text-white/50 hover:text-white/80"
    >
...
export default function AdminDashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen relative flex" style={{ background: '#0A1A2A' }}>
      <AmbientBackground />
      ...
      >
        ...
        <div className="px-6 pt-8 pb-4">
          <h1 className="text-xl font-bold tracking-tight" style={{ color: '#D4AF37' }}>
            ToSom
          </h1>
        ...
        <nav className="flex-1 px-4 space-y-1 overflow-y-auto">
          <NavItem href="/admin/dashboard" icon={<svg width="16" height="16" viewBox="0 0 24 24" fill="#D4AF37"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>} label="Dashboard" />
