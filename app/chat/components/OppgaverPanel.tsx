    ...
    <FadeIn variant="scaleIn" scrollTrigger>
      <div
        ...
        style={{
          ...
          // utvides når en oppgave er valgt slik at linjen alltid er synlig.
          maxHeight: panelOpen ? (selectedTask ? '640px' : '480px') : '0px',
      ...
      >
        ...
        {/* ═══ OPPGAVE VALGT — fast send-linje i bunn av panelet ═══
            Vises så fort en oppgave er valgt, uten at man må skrolle
