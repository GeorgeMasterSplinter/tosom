...
import { radius, colors, motion } from '@/design/tokens';
...
export const ToSomBadge: FC<ToSomBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center justify-center px-3 py-1.5 text-xs font-medium rounded-lg transition-all ${motion.durations.fast} ${motion.easings.fadeIn} ${className}`}
      style={{
        background: vs.bg,
